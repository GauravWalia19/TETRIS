...
public class Rain
{
    ...
    public final String BBLUE = "\u001B[1;34m";		//BOLD BLUE
    ...
    public final String BWHITE = "\u001B[1;37m";	//BOLD WHITE
    public final String IWHITE = "\u001B[3;37m";	//ITALIC WHITE
    ...
    public final String UBGRED = "\u001B[4;41m";	    //UNDERLINE TEXT-RED BACKGROUND

    public final String BBGLGREEN = "\u001B[1;42m";     //BOLD TEXT-LIGHT GREEN BACKGROUND
    public final String IBGLGREEN = "\u001B[3;42m";	    //ITALIC TEXT-LIGHT GREEN BACKGROUND
    public final String UBGLGREEN = "\u001B[4;42m";	    //UNDERLINE TEXT-LIGHT GREEN BACKGROUND

    public final String BBGORANGE = "\u001B[1;43m";	    //BOLD TEXT-ORANGE BACKGROUND
    public final String IBGORANGE = "\u001B[3;43m";	    //ITALIC TEXT-ORANGE BACKGROUND
    public final String UBGORANGE = "\u001B[4;43m";	    //UNDERLINE TEXT-ORANGE BACKGROUND

    public final String BBGLBLUE = "\u001B[1;44m";	    //BOLD TEXT-LIGHT BLUE BACKGROUND
    public final String IBGLBLUE = "\u001B[3;44m";		//ITALIC TEXT-LIGHT BLUE BACKGROUND
    public final String UBGLBLUE = "\u001B[4;44m";		//UNDERLINE TEXT-LIGHT BLUE BACKGROUND

    public final String BBGPINK = "\u001B[1;45m";		//BOLD TEXT-PINK BACKGROUND
    public final String IBGPINK = "\u001B[3;45m";		//ITALIC TEXT-PINK BACKGROUND
    ...
    public final String UBGWHITE = "\u001B[4;47m";		//UNDERLINEWHITE-GREEN BACKGROUND
